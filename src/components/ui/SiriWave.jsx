...
/**
 * @typedef {Object} SiriWaveProps
 * @property {("wave"|"fluid-dots")} [variant="wave"] - Which shader to render
 * @property {number} [size=420] - CSS display size of the square canvas, in px
 * @property {number} [renderScale=0.75] - Internal render resolution multiplier
 */
...
export function SiriWave({
  ...
  return (
    <canvas
      ref={canvasRef}
      className={cn("block rounded-[20px]", className)}
